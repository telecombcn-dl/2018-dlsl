...
* 20/11: Guest Lecture 1: [Oriol Vinyals][OriolVinyals] (Google Deepmind) & [Yannins Kalantidis][YannisKalantidis] (Facebook Research) - [RSVP here][guest1-rsvp]
* 21/11: RNN extensions (MRC) - Attention models (MRC) 
* 28/11: Generative models (SP)
* 05/12: Holiday
* 12/12: Project Presentations (XG, MRC, ES)
* 19/12: Guest lecture 2: [Cristian Canton][CristianCanton] (Facebook, Seattle, WA, USA)
